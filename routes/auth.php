...
Route::middleware('guest')->group(function () {
    ...
    Route::redirect('/register', '/choose-plan');
    Route::redirect('/sign-up', '/choose-plan');

    Route::get('/choose-plan', [RegisteredUserController::class, 'choosePlan'])
        ->name('choose-plan');

    Route::controller(SocialLoginController::class)->prefix('/auth')->group(function () {
        Route::get('/google', 'redirectToGoogle')->name('auth.google');
        Route::get('/google/redirect', 'handleGoogleCallback');
    });
...
//        ->name('sign-up');
    ...
    Route::inertia('complete-profile', 'Auth/Profile')
