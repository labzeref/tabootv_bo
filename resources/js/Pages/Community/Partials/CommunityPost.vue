...
const deletePost = () => {
    axios.delete(route('posts.destroy', props.post.id)).then(response => {
    ...
    <div class="d-flex items-center gap-2 mb-3 pl-7">
        <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M7.5 2.20046C11.6607 -2.07653 22.0635 5.40774 7.5 15.0314C-7.06352 5.40867 3.33926 -2.07653 7.5 2.20046Z"
                  fill="#9F9F9F"/>
        </svg>
    ...
    <div class="comment-div">
        ...
        <div class="w-full">
            <div class="d-flex items-center justify-between w-full gap-1">
                ...
                <v-menu v-model="isMenuOpen" v-if="$page.props.auth.user.id === post.user_id">
                    <template v-slot:activator="{ props }">
                        ...
                        <svg width="16" height="4" viewBox="0 0 16 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M7.68081 2.86529C8.15875 2.86529 8.5462 2.47784 8.5462 1.99991C8.5462 1.52197 8.15875 1.13452 7.68081 1.13452C7.20288 1.13452 6.81543 1.52197 6.81543 1.99991C6.81543 2.47784 7.20288 2.86529 7.68081 2.86529Z"
                                fill="#9F9F9F" stroke="#9F9F9F" stroke-width="1.15385" stroke-linecap="round"
                                stroke-linejoin="round"/>
                            <path
                                d="M13.7384 2.86529C14.2164 2.86529 14.6038 2.47784 14.6038 1.99991C14.6038 1.52197 14.2164 1.13452 13.7384 1.13452C13.2605 1.13452 12.873 1.52197 12.873 1.99991C12.873 2.47784 13.2605 2.86529 13.7384 2.86529Z"
                                fill="#9F9F9F" stroke="#9F9F9F" stroke-width="1.15385" stroke-linecap="round"
                                stroke-linejoin="round"/>
                            <path
                                d="M1.6232 2.86529C2.10114 2.86529 2.48858 2.47784 2.48858 1.99991C2.48858 1.52197 2.10114 1.13452 1.6232 1.13452C1.14526 1.13452 0.757812 1.52197 0.757812 1.99991C0.757812 2.47784 1.14526 2.86529 1.6232 2.86529Z"
                                fill="#9F9F9F" stroke="#9F9F9F" stroke-width="1.15385" stroke-linecap="round"
                                stroke-linejoin="round"/>
                        </svg>
                   </span>
                    ...
                    <v-list class="px-2 border min-w-[170px] rounded-lg mt-6">
                        ...
                        >
                            <v-btn class="min-h-[46px] p-0 flex items-center shadow-none" style="padding: 0 !important;"
                               ...
                               elevation="0"
                        >
                            <span class="flex gap-2 items-center">Delete</span>
                            </v-btn>
                        </v-list-item>
                    </v-list>
                </v-menu>
