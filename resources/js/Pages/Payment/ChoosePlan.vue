...
<template>
    ...
    <div class="grid grid-cols-12 gap-7 max-w-[1108px] mx-auto w-full">
<!--        <div-->
...
<!--    </div>-->
        <div
            class=" w-full col-span-12 lg:col-span-12   bg-[#0A070B]/70 rounded-[20px] overflow-hidden relative p-5 md:pt-10 md:pb-[43px] md:px-6   gap-4 md:gap-x-4 md:gap-y-0 justify-between ">
            ...
            <div class="flex items-center">
               <div class="flex flex-col justify-between items-center min-h-[500px] w-full md:w-fit gap-6">
                <div class="md:min-h-[168px] md:mr-auto space-y-5 md:space-y-10">
                    ...
                    <h6 class="text-secondary ml-4 leading-snug max-w-[300px] xl:max-w-[350px] w-full" style="line-height: 34px !important"
                        v-html="formatAsteriskString(activePlan.title, 'text-white font-bold')"></h6>
                </div>

                <!-- list  -->
                <ul class="space-y-3 md:hidden md:space-y-5 text-secondary mx-auto md:min-w-[340px] md:relative fm-book text-[15px]">
