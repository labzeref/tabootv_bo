...
const form = useForm({
    ...
    location: props.video.location ?? '',
    duration: props.video.duration ?? '',
    country: props.video.country_id ?? '',
    creator: props.video.user_id ?? '',
    thumbnail: null,
    video: null,
})

const submit = () => {
    form.post(route('contents.video.update', props.video.id))
}
</script>
            ...
            <div class="overflow-auto">
                <form @submit.prevent="submit">
                    <div class="col-span-12 xl:col-span-8">
                        ...
                        <button  class="btn btn-primary btn-sm max-w-[257px] w-full mb-[25px]">Update</button>
                        <p v-if="video.published_at" style="    color: var(--primary-color);">you only can update unpublished videos</p>
