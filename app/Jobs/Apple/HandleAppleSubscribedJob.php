...
class HandleAppleSubscribedJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            /**
             * We have only two subtypes for SUBSCRIBED notification type
             * which are INITIAL_BUY and RESUBSCRIBE and the action is
