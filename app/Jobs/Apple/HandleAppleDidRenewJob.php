...
class HandleAppleDidRenewJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            /**
             * We have only one subtype for DID_RENEW notification type
             * which is BILLING_RECOVERY, and otherwise it will be NULL and the action is
             * same for both that is why not checking the subtype
             */
